...
namespace NT.XUnit.TestMeta
{
    public class TestContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserRole>(e => { e.Property(p => p.Description).HasMaxLength(50).HasDefaultValue("cccccccccccccccccc"); });
            modelBuilder.Entity<UserRole>(e => { e.Property(p => p.DisplayName).HasComputedColumnSql("[LastName] + ', ' + [FirstName]"); });
    ...
    public static class ContextUtil
    {
        public static DbContextOptions GetOptions()
        {
            ...
            var connectionString = $"Server=localhost;Port=3306;Database=myDataBase;Uid=root;Pwd = Hpi123;";
            builder.UseMySQL(connectionString); // Can NOT Test with UseInMemoryDb (Exception: Relational-specific methods can only be used when the context is using a relational)
