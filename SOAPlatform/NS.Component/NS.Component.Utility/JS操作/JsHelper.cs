...
namespace NS.Component.Utility
{
    ...
    public class JsHelper
    {
        ...
        public static void AlertAndRedirect(string message, string toURL)
        {
            ...
            NSHttpContext.Current.Response.WriteAsync(string.Format(js, message, toURL));
        ...
        public static void AlertAndGoHistory(string message, int value)
        {
            ...
            NSHttpContext.Current.Response.WriteAsync(string.Format(js, message, value));
            NSHttpContext.Current.Response.StatusCode = StatusCodes.Status200OK;
        }
        ...
        public static void Redirect(string toUrl)
        {
            ...
            NSHttpContext.Current.Response.WriteAsync(string.Format(js, toUrl));
        }
        ...
        public static void BackHistory(int value)
        {
            ...
            NSHttpContext.Current.Response.WriteAsync(string.Format(js, value));
            NSHttpContext.Current.Response.StatusCode = StatusCodes.Status200OK;
        }
        ...
        public static void Alert(string message)
        {
            ...
            NSHttpContext.Current.Response.WriteAsync(string.Format(js, message));
        }
