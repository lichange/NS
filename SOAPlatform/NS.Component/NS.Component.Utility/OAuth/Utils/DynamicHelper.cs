...
namespace NS.Component.Utility.OAuth
{
    ...
    public static class DynamicHelper
    {
        ...
        {
            dynamic dynamicObject = JObject.Parse(jsonString);
    ...
    //        get
    //        {
    //            return new ReadOnlyCollection<Type>(new List<Type>(new Type[] { typeof(object), typeof(DynamicJsonObject), typeof(System.Dynamic.ExpandoObject) }));
    //        }
