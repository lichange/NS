...
namespace NS.Component.Utility.OAuth
{
    ...
    public abstract class OAuthClient : IOAuthClient
    {
        ...
        public virtual dynamic GetUserInfo()
        {
            return String.Empty;
        }
        ...
        {
            String responseResult = Get(this.Option.Urls["EndSession"], new RequestOption()
            {
                Name = "access_token",
        ...
        protected virtual RequestOption[] RequestGetExecuting(params RequestOption[] parameters)
        {
            return parameters;
        }
        protected virtual RequestOption[] RequestPostExecuting(params RequestOption[] parameters)
        {
            return parameters;
        }
        ...
        protected virtual AuthToken GetAccessToken(GrantType type, Dictionary<string, string> parameters)
        {
            ...
            switch (type)
            {
                case GrantType.AuthorizationCode:
                    {
                        accessTokenOptions.Add(new RequestOption()
                        {
                            Name = "grant_type",
                ...
                case GrantType.RefreshToken:
                    {
                        ...
                        {
                            Name = "refresh_token",
                            Value = parameters["refresh_token"]
                        });
                    }
                    break;
            }
        ...
        private string RequestUrlExecuting(string apiUrl)
        {
            ...
            else
            {
                ...
                if (this.Option.ApiUrlBase.EndsWith("/"))
                    baseApiUrl = this.Option.ApiUrlBase.Remove(this.Option.ApiUrlBase.Length - 1, 1);
