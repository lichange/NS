...
//        static Dictionary<String, ScriptEngine> _cache = new Dictionary<String, ScriptEngine>(StringComparer.OrdinalIgnoreCase);
...
//                _cache.Add(key, new ScriptEngine(code, isExpression));
...
//                names[i] = "p" + i;
//            }
//            var types = GetTypeArray(parameters);
...
//            if (Method == null) throw new Exception("脚本引擎未编译表达式！");
