...
namespace NS.Component.Utility
{
    public class FileOperate
    {
         ...
         *           string s = NS.Component.Utility.FileOperate.GetPostfixStr(filename);         
        *****************************************/
        /// <summary>
        /// 取后缀名
        /// </summary>
         ...
         *           NS.Component.Utility.FileOperate.WriteFile(Path,Strings);
        *****************************************/
        /// <summary>
        /// 写文件
        /// </summary>
        ...
        /// <param name="false">文件内容</param>
        public static void WriteFile(string Path, string Strings, bool isAppend = false)
        {
            ...
            System.IO.StreamWriter f2 = new System.IO.StreamWriter(Path, isAppend, System.Text.Encoding.UTF8);
         ...
         * 调用示列：
         *           string Path = Server.MapPath("Default2.aspx");       
         *           string s = NS.Component.Utility.FileOperate.ReadFile(Path);
        *****************************************/
        /// <summary>
        /// 读文件
        /// </summary>
         ...
         *           NS.Component.Utility.FileOperate.FileAdd(Path, Strings);
        *****************************************/
        /// <summary>
        /// 追加文件
        /// </summary>
         ...
         *           NS.Component.Utility.FileOperate.FileCoppy(OrignFile, NewFile);
        *****************************************/
        /// <summary>
        /// 拷贝文件
        /// </summary>
         ...
         *           NS.Component.Utility.FileOperate.FileDel(Path);
        *****************************************/
        /// <summary>
        /// 删除文件
        /// </summary>
         ...
         *            NS.Component.Utility.FileOperate.FileMove(OrignFile, NewFile);
        *****************************************/
        /// <summary>
        /// 移动文件
        /// </summary>
         ...
         *           NS.Component.Utility.FileOperate.FolderCreate(OrignFolder, NewFloder); 
        *****************************************/
        /// <summary>
        /// 在当前目录下创建目录
        /// </summary>
         ...
         *           NS.Component.Utility.FileOperate.DeleteFolder(dir);       
        *****************************************/
        /// <summary>
        /// 递归删除文件夹目录及文件
        /// </summary>
         ...
         *           NS.Component.Utility.FileOperate.CopyDir(srcPath,aimPath);   
        *****************************************/
        /// <summary>
         ...
         *           this.Literal1.Text = NS.Component.Utility.FileOperate.GetFoldAll(strDirlist);  
        *****************************************/
        /// <summary>
        /// 获取指定文件夹下所有子目录及文件
        /// </summary>
         ...
         * 调用示列：
         *            string strDirlist = Server.MapPath("templates");      
         *            this.Literal2.Text = NS.Component.Utility.FileOperate.GetFoldAll(strDirlist,"tpl","");
        *****************************************/
        /// <summary>
         ...
         *           Response.Write(NS.Component.Utility.FileOperate.GetDirectoryLength(Path));       
        *****************************************/
        /// <summary>
        /// 获取文件夹大小
        /// </summary>
         ...
         *            Response.Write(NS.Component.Utility.FileOperate.GetFileAttibe(file));         
        *****************************************/
        /// <summary>
        /// 获取指定文件详细属性
        /// </summary>
