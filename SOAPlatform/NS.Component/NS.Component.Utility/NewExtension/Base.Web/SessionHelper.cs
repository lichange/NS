...
namespace NS.Component.Utility
{
    ...
    public class SessionHelper
    {
        ...
        {
            NSHttpContext.Current.Session.SetString(strSessionName, Convert.ToString(objValue));
        }
        #endregion
        ...
        //    else if (iYear > 0)
        //    {
        //        NSHttpContext.Current.Session.Timeout = 60 * 24 * 365 * iYear;
        //    }
        //}
        #endregion
        ...
        {
            return NSHttpContext.Current.Session.GetString(strSessionName);
        }
        #endregion
        ...
        {
            NSHttpContext.Current.Session.Remove(strSessionName);
        }
        #endregion
    }
}
