...
namespace NS.Component.JobManage
{
  /// <summary>
  /// 计划任务管理器
  /// </summary>
  public sealed class ScheduleTaskManager : IDisposable
  {
    ...
    /// <param name="e">The <see cref="NS.Component.JobManage.ScheduleTaskTerminatedEventArgs"/> instance containing the event data.</param>
