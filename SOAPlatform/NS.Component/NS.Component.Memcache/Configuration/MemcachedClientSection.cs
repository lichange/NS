...
using System.Net;
using NS.Component.Memcache.Caching.Memcached;
using NS.Component.Memcache.Reflection;
...
namespace NS.Component.Memcache.Caching.Configuration
{
	...
	public sealed class MemcachedClientSection : ConfigurationSection, IMemcachedClientConfiguration
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="T:NS.Component.Memcache.Caching.Memcached.IMemcachedNodeLocator"/> which will be used to assign items to Memcached nodes.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="T:NS.Component.Memcache.Caching.Memcached.IMemcachedKeyTransformer"/> which will be used to convert item keys for Memcached.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="T:NS.Component.Memcache.Caching.Memcached.ITranscoder"/> which will be used serialzie or deserialize items.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="T:NS.Component.Memcache.Caching.Memcached.IPerformanceMonitor"/> which will be used monitor the performance of the client.
		/// </summary>
		...
		IServerPool IMemcachedClientConfiguration.CreatePool()
		{
			switch (this.Protocol)
			{
				...
				case MemcachedProtocol.Binary: return new NS.Component.Memcache.Caching.Memcached.Protocol.Binary.BinaryPool(this);
			}
