...
using NS.Component.Memcache.Caching.Memcached.Protocol.Binary;
...
namespace NS.Component.Memcache.Caching.Configuration
{
	...
	public class MemcachedClientConfiguration : IMemcachedClientConfiguration
	{
		...
		/// <summary>
		/// Gets or sets the Type of the <see cref="T:NS.Component.Memcache.Caching.Memcached.IMemcachedNodeLocator"/> which will be used to assign items to Memcached nodes.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="T:NS.Component.Memcache.Caching.Memcached.ITranscoder"/> which will be used serialize or deserialize items.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="T:NS.Component.Memcache.Caching.Memcached.IPerformanceMonitor"/> instance which will be used monitor the performance of the client.
		/// </summary>
