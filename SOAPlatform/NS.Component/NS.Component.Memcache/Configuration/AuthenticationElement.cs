...
namespace NS.Component.Memcache.Caching.Configuration
{
	...
	public sealed class AuthenticationElement : ConfigurationElement, IAuthenticationConfiguration
	{
		...
		/// <summary>
		/// Gets or sets the type of the <see cref="T:NS.Component.Memcache.Caching.Memcached.IAuthenticationProvider"/> which will be used authehticate the connections to the Memcached nodes.
		/// </summary>
		[ConfigurationProperty("type", IsRequired = false), TypeConverter(typeof(TypeNameConverter)), InterfaceValidator(typeof(NS.Component.Memcache.Caching.Memcached.ISaslAuthenticationProvider))]
		public Type Type
		{
		...
		Type IAuthenticationConfiguration.Type
		{
			...
			set
			{
				ConfigurationHelper.CheckForInterface(value, typeof(NS.Component.Memcache.Caching.Memcached.ISaslAuthenticationProvider));
