...
using NS.Component.Memcache.Collections;
...
namespace NS.Component.Memcache.Caching.Memcached
{
	/// <summary>
	...
	{
		private static readonly NS.Component.Memcache.Caching.ILog log = NS.Component.Memcache.Caching.LogManager.GetLogger(typeof(MemcachedNode));
		...
		{
			private static readonly NS.Component.Memcache.Caching.ILog log = NS.Component.Memcache.Caching.LogManager.GetLogger(typeof(InternalPoolImpl).FullName.Replace("+", "."));
