...
using NS.Component.Memcache.Caching.Memcached.Results.Helpers;

namespace NS.Component.Memcache.Caching.Memcached.Protocol.Binary
{
	public class DeleteOperation : BinarySingleItemOperation, IDeleteOperation
	{
		private static readonly NS.Component.Memcache.Caching.ILog log = NS.Component.Memcache.Caching.LogManager.GetLogger(typeof(DeleteOperation));
