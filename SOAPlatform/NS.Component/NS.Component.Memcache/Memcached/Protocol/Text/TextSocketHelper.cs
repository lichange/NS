...
namespace NS.Component.Memcache.Caching.Memcached.Protocol.Text
{
	internal static class TextSocketHelper
	{
		...
		private static readonly NS.Component.Memcache.Caching.ILog log = NS.Component.Memcache.Caching.LogManager.GetLogger(typeof(TextSocketHelper));
		...
		/// using the <see cref="M:NS.Component.Memcache.Caching.Memcached.PooledSocket.Write(IList&lt;ArraySegment&lt;byte&gt;&gt;)"/>
		/// </summary>
		...
		/// and use the <see cref="M:NS.Component.Memcache.Caching.Memcached.PooledSocket.Write(IList&lt;ArraySegment&lt;byte&gt;&gt;)"/> to send the command and the additional buffers in one transaction.</remarks>
