...
namespace NS.Component.Memcache.Caching.Memcached.Protocol
{
	/// <summary>
	...
	{
		private static readonly NS.Component.Memcache.Caching.ILog log = NS.Component.Memcache.Caching.LogManager.GetLogger(typeof(Operation));
