...
namespace NS.Component.Memcache.Caching.Memcached
{
	...
	public sealed class KetamaNodeLocator : IMemcachedNodeLocator
	{
		...
		private static readonly Dictionary<string, Func<HashAlgorithm>> hashFactory = new Dictionary<string, Func<HashAlgorithm>>(StringComparer.OrdinalIgnoreCase)
		{
		    ...
		    { "fnv1_32", () => new NS.Component.Memcache.FNV1() },
		    { "fnv1_64", () => new NS.Component.Memcache.FNV1a() },
		    { "fnv1a_32", () => new NS.Component.Memcache.FNV64() },
		    { "fnv1a_64", () => new NS.Component.Memcache.FNV64a() },
