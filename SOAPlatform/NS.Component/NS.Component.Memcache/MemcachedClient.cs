...
using NS.Component.Memcache.Caching.Memcached.Results.Factories;
...
namespace NS.Component.Memcache.Caching
{
	...
	public partial class MemcachedClient : IMemcachedClient, IMemcachedResultsClient
	{
		...
		private static readonly NS.Component.Memcache.Caching.ILog log = NS.Component.Memcache.Caching.LogManager.GetLogger(typeof(MemcachedClient));
