...
namespace NS.Component.Memcache.Caching
{
	public class DiagnosticsLogFactory : ILogFactory
	{
		...
		public DiagnosticsLogFactory() : this(ConfigurationManager.AppSettings["NS.Component.Memcache.Caching.Diagnostics.LogPath"]) { }

		public DiagnosticsLogFactory(string logPath)
		{
			if (String.IsNullOrEmpty(logPath))
				throw new ArgumentNullException(
					"Log path must be defined.  Add the following to configuration/appSettings: <add key=\"NS.Component.Memcache.Caching.Diagnostics.LogPath\" "
