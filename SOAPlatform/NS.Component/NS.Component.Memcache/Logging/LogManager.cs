...
namespace NS.Component.Memcache.Caching
{
	/// <summary>
	...
	///				<section name="log" type="NS.Component.Memcache.Caching.EnyimLoggerSection, NS.Component.Memcache.Caching" />
	///			</sectionGroup>
	///		</configSections>
	///		<enyim.com>
	///			<log factory="NS.Component.Memcache.Caching.Log4NetLoggerFactory, NS.Component.Memcache.Caching" />
	///		</enyim.com>
	/// </configuration>
	/// 
	/// Code:
	...
	public static class LogManager
	{
		...
		static LogManager()
		{
			var section = ConfigurationManager.GetSection("enyim.com/log") as NS.Component.Memcache.Caching.Configuration.LoggerSection;
			ILogFactory f = null;

			if (section != null && section.LogFactory != null)
			{
				f = NS.Component.Memcache.Reflection.FastActivator.Create(section.LogFactory) as ILogFactory;
			}
#if !log4net
