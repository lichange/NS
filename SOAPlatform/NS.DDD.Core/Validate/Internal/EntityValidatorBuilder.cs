...
namespace NS.DDD.Core.Internal.Validation
{
    ...
    internal class EntityValidatorBuilder
    {
        ...
        /// </returns>
        protected virtual ComplexTypeValidator BuildComplexTypeValidator(Type clrType)
        {
            ...
            where T : TypeValidator
        {
            var propertyValidators = BuildValidatorsForProperties(
                GetPublicInstanceProperties(clrType), navigationProperties);
        ...
        protected virtual PropertyValidator BuildPropertyValidator(
            PropertyInfo clrProperty, bool buildFacetValidators)
        {
            ...
            {
                propertyAttributeValidators.AddRange(BuildFacetValidators(clrProperty, attributes));
            }
        ...
        protected virtual IEnumerable<IValidator> BuildFacetValidators(
            PropertyInfo clrProperty, IEnumerable<Attribute> existingAttributes)
        {
            DebugCheck.NotNull(clrProperty);
            //DebugCheck.NotNull(edmProperty);
            ...
            //MetadataProperty storeGeneratedItem=null;
            ...
            if (clrProperty.PropertyType.IsValueType
                &&
            ...
            //{
            //    facetDerivedAttributes.Add(new MaxLengthAttribute(50));
            //}
