...
namespace NS.DDD.Core.Adapter
{
        ...
        : ITypeAdapter
    {
            ...
            where TTarget : class, new()
        {
            ...
            //return CoreMapper<TSource, TTarget>.Map(source); //TinyMapper.Map<TSource, TTarget>(source);
        }
        ...
        public TTarget Adapt<TTarget>(object source) where TTarget : class, new()
        {
            ...
            //return null; //TinyMapper.Map<TTarget>(source);
        }

        public Type GetMapTarget(Type type)
        {
            var tempMap = Mapper.Configuration.GetAllTypeMaps().Where(pre => pre.SourceType == type).FirstOrDefault();
