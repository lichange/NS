        ...
        public List<Assembly> GetMappingAssemblys
        {
            get
            {
                ...
                if (NS.Framework.Config.PlatformConfig.ServerConfig.ConfigFilePath.EndsWith("bin"))
                    tempPath = System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "bin");
                else
                    tempPath = System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory);
