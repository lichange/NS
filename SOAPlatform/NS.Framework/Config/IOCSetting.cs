...
namespace NS.Framework.Config
{
    ...
    public class IOCSetting
    {
        ...
        private string fileDiscoveryPath = System.AppDomain.CurrentDomain.BaseDirectory;
        /// <summary>
        /// IOC注册时程序集查找的目录
        /// </summary>
    ...
    public class InterceptorItem
    {
        ...
        /// 是否启用
        /// </summary>
        [System.Xml.Serialization.XmlAttribute("IsEnable")]
