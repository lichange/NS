...
namespace NS.Framework.Cache
{
    ...
    /// <summary>
    /// CacheProvider 扩展服务接口
    /// </summary>
    public interface ICacheProviderEx : ICacheProvider
    {
        /// <summary>
        /// 向缓存中添加一个对象。
        /// </summary>
        ...
        /// <param name="valKey">缓存值的键值，该值通常是由使用缓存机制的方法的参数值所产生。</param>
        /// <param name="value">需要缓存的对象。</param>
        /// <param name="expireTime">缓存超时时长。</param>
        void Add(string key, string valKey, object value,DateTime expireTime);
        /// <summary>
        /// 向缓存中更新一个对象。
        /// </summary>
        /// <param name="key">缓存的键值，该值通常是使用缓存机制的方法的名称。</param>
        ...
        /// <param name="value">需要缓存的对象。</param>
        /// <param name="expireTime">缓存超时时长。</param>
        void Put(string key, string valKey, object value, DateTime expireTime);
    }
}
