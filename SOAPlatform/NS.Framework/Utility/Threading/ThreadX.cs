...
namespace NS.Framework.Utility.Threading
{
    ...
    class ThreadX : IDisposable
    {
        ...
        public Boolean CanRelease
        {
            get
            {
                ...
                //半分钟不活动的可以释放
                if (AliveTime.AddSeconds(180) < DateTime.Now)
                    return true;
                return false;
            }
        }
        ...
        public void Start()
        {
            if (internalEvent == null)
                internalEvent = new AutoResetEvent(false);
        ...
        {
        //    if (Debug)
        //        XTrace.WriteLine("线程：" + Thread.CurrentThread.Name + " 信息：" + msg);
        }
