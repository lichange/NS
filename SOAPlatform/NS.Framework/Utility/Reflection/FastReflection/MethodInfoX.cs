...
namespace NS.Framework.Utility.Reflection
{
    ...
    public class MethodInfoX : MemberInfoX
    {
        ...
        FastInvokeHandler Handler
        {
            get
            {
                if (_Handler == null)
                {
                    ...
                    if (m == null) throw new Exception(string.Format("不支持{0}类型方法的快速反射！", Method.GetType().Name));
        ...
        public static TResult Invoke<TResult>(Object target, String name, params Object[] parameters)
        {
            ...
            if (mix == null) throw new Exception(string.Format("类{0}中无法找到{1}方法！", target.GetType().Name, name));
        ...
        public static TResult Invoke<TTarget, TResult>(String name, params Object[] parameters)
        {
            ...
            if (mix == null) throw new Exception(string.Format("类{0}中无法找到{1}方法！", typeof(TTarget).Name, name));
