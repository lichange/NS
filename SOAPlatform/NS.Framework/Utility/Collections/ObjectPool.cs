...
using NS.Framework.Utility.Threading;
using System;
using System.Diagnostics;
using System.Threading;

namespace NS.Framework.Utility.Collections
{
    ...
    public class ObjectPool<T> : DisposeBase //where T : new()
    {
        ...
        public NS.Framework.Utility.Reflection.Func<T> OnCreate;
        #endregion
        ...
        public virtual void Push(T obj)
        {
            ...
            if (stack.Count > Max)
            {
                if (_clearTimers == null) _clearTimers = new TimerX(ClearAboveMax, null, 0, 120000);
            }
            else
            {
                // 没到最大值，关闭定时器？
