// ***********************************************************************
// Assembly         : NS.SSO.Application
// Author           : hegezhou
// Created          : 07-08-2016
//
// Last Modified By : hegezhou
...
namespace NS.SSO.Application
{
    ...
    public class AuthUtil
    {
        ...
        public static UserWithACL GetCurrentUser(string remark = "")
        {
            ...
            {
                var value = _helper.Get(null, requestUri);
                var result = JsonHelper.Instance.Deserialize<Response<UserWithACL>>(value);
                if (result.Code == 200)
                {
                    return result.Result;
                }
